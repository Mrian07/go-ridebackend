...
|
*/
$config['base_url'] = 'http://daviruzsystems.com/';

define('firebaseDb', 'https://your-firebase-database/');
define('keyfcm', 'your-fcm-key');

define('purchase_code', 'your-purchase-code');
define('google_maps_api', 'your-google-maps-api');
